                    ...
                    <div className={`rounded-2xl border overflow-hidden transition-all ${
                      ...
                      <div className="w-full flex items-center justify-between hover:bg-white/[0.02]">
                        ...
                        <button 
                          ...
                          className="p-5 text-slate-500 hover:text-white transition-all"
                    ...
                    <div className="flex bg-white/5 p-1 rounded-full border border-white/5">
                      <button 
                        ...
                        className={`text-[9px] font-black px-3 py-1.5 rounded-full transition-all uppercase tracking-tighter ${
                          (activeP as any).status === 'needs_action' ? 'bg-rose-500 text-white shadow-lg' : 'text-slate-500 hover:text-rose-400'
                        }`}
                      >
                        Needs Action
                      </button>
                      <button 
                        ...
                        className={`text-[9px] font-black px-3 py-1.5 rounded-full transition-all uppercase tracking-tighter ${
                          (activeP as any).status === 'caught_up' ? 'bg-emerald-500 text-white shadow-lg' : 'text-slate-500 hover:text-emerald-400'
                        }`}
                      >
                        Caught Up
                      </button>
